  ...
  <section>
    ...
    >
      <div className="container">
        <h3>Precisa da nossa ajuda?</h3>
        <h4>
          Se você ainda não escolheu o curso que pode te ajudar a alcançar o
          sucesso profissional, deixe o seu contato e conte com a ajuda de um
          especialista em aconselhamento educacional.
        </h4>
    ...
    <amp-img
      ...
      src="/static/images/especialista_ajudando_estudante_de_pos_graduacao.webp"
      width="460"
      height="610"
      layout="responsive"
    >
      <amp-img
        fallback=""
        alt="Aluno feliz com nossos cursos online"
        src="/static/images/especialista_ajudando_estudante_de_pos_graduacao.jpg"
        width="460"
        height="610"
        layout="responsive"
      ></amp-img>
